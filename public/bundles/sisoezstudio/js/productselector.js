                    ...
                    <li class="ez-collection__item" v-for="(product,index) in sku_list" :key="product.sku">
                        <div>
                            <!-- svg class="ibexa-icon ibexa-icon--secondary">
                                <use xlink:href="/bundles/ezplatformadminui/img/ibexa-icons.svg#drag"></use>
                            </svg -->
                        </div>
                        ...
                        <div class="ez-collection__item-trash" v-if="index > 0">
                                 <svg class="ibexa-icon ibexa-icon--medium ibexa-icon--secondary" @click="skuUp(index)">
                                    <use xlink:href="/bundles/ezplatformadminui/img/ibexa-icons.svg#caret-up"></use>
                                </svg>
                         </div>
                         <div class="ez-collection__item-trash" v-if="index < sku_list.length -1">
                                <svg class="ibexa-icon ibexa-icon--medium ibexa-icon--secondary" @click="skuDown(index)">
                                    <use xlink:href="/bundles/ezplatformadminui/img/ibexa-icons.svg#caret-down"></use>
                                </svg>
                          </div>
                         <div class="ez-collection__item-trash">
                                <svg class="ibexa-icon ibexa-icon--medium ibexa-icon--secondary" @click="removeSku(index)">
                                    <use xlink:href="/bundles/ezplatformadminui/img/ibexa-icons.svg#trash"></use>
                                </svg>
                        </div>
                    </li>
             </ol>
            ...
            <ol class="ez-collection__items">
              <li style="border: 2px solid #106d95" v-for="(sku,index) in productSuggestions" class="ez-collection__item">
                ...
                <svg @click="addSku(index)" style="cursor:pointer" class="ibexa-icon ibexa-icon--medium ibexa-icon--secondary">
                  <use xlink:href="/bundles/ezplatformadminui/img/ibexa-icons.svg#create"></use>
                </svg>
              </li>
            </ol>
