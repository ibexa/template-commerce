...
(function(global, doc, ibexa) {
    ...
    const fetchShippingCosts = () => {
        const url = Routing.generate('ibexa.commerce.menu.admin.shipping_costs.fetch');
    ...
    const save = () => {
        ...
        const request = new Request(Routing.generate('ibexa.commerce.menu.admin.shipping.costs.update'), {
            method: 'POST',
