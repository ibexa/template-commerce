...
(function(global, doc, eZ) {
    ...
    const renderShippingMethodsOptions = (shippingMethodsDropdown) => {
        const sourceInput = shippingMethodsDropdown.querySelector('.ibexa-dropdown__source-input');
    ...
    const addRow = (shippingCosts) => {
        ...
        const countryDropdown = new eZ.core.Dropdown({
            container: countryDropdownNode,
        });
        const shippingMethodDropdown = new eZ.core.Dropdown({
