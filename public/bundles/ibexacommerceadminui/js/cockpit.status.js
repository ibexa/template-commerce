(function(global, doc, eZ) {
    ...
    const showCartsStats = (data) => {
        ...
        cartsWidget.querySelector('.ibexa-icon').removeAttribute('hidden');
    ...
    const showCustomerStats = (data) => {
        ...
        customersWidget.querySelector('.ibexa-icon').removeAttribute('hidden');
    ...
    const showProductStats = (data) => {
        ...
        productsWidget.querySelector('.ibexa-icon').removeAttribute('hidden');
    ...
    const showSalesStats = (data) => {
        ...
        salesWidget.querySelector('.ibexa-icon').removeAttribute('hidden');
    ...
    const showOrdersStats = (data) => {
        ...
        ordersWidget.querySelector('.ibexa-icon').removeAttribute('hidden');
    ...
    doc.querySelectorAll('a[data-bs-toggle="tab"]').forEach((tab) =>
