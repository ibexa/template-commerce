(function(global, doc, ibexa, flatpickr, moment, React, ReactDOM) {
    ...
    const { convertDateToTimezone, formatFullDateTime } = ibexa.helpers.timezone;
    const { dateFormat } = ibexa.adminUiConfig;
...
})(window, window.document, window.ibexa, window.flatpickr, window.moment, window.React, window.ReactDOM);
